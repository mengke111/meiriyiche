...
//	private int headContentWidth;
	...
	private void init(Context context) {
		setCacheColorHint(context.getResources().getColor(R.color.light_bule));
...
//			lastUpdatedTextView.setVisibility(View.VISIBLE);
			...
			tipsTextview.setText(this.getResources().getString(R.string.scan_up));
...
//			lastUpdatedTextView.setVisibility(View.VISIBLE);
			...
			if (isBack) {
				...
				tipsTextview.setText(this.getResources().getString(R.string.scan_down));
			} else {
				tipsTextview.setText(this.getResources().getString(R.string.scan_down));
			}
//			Log.v(TAG, "褰撳墠鐘舵�锛屼笅鎷夊埛鏂�);
		...
		case REFRESHING:
			...
			tipsTextview.setText(this.getResources().getString(R.string.scan_update));
//			lastUpdatedTextView.setVisibility(View.VISIBLE);
...
//			Log.v(TAG, "褰撳墠鐘舵�,姝ｅ湪鍒锋柊...");
		...
		case DONE:
			...
			progressBar.setVisibility(View.GONE);
			arrowImageView.clearAnimation();
			arrowImageView.setImageResource(R.drawable.ic_arrow);
			tipsTextview.setText(this.getResources().getString(R.string.scan_down));
//			lastUpdatedTextView.setVisibility(View.VISIBLE);
...
//			Log.v(TAG, "褰撳墠鐘舵�锛宒one");
	...
	public void onRefreshComplete() {
		state = DONE;
//		lastUpdatedTextView.setText(this.getResources().getString(R.string.scan_time) + new Date().toLocaleString());
		changeHeaderViewByState();
	}
